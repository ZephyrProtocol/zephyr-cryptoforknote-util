    ...
    "targets": [
        {
            ...
            "cflags_c":  [
                "-fno-exceptions -fno-rtti -std=gnu11 -march=native -fPIC -m64 -DNDEBUG -Ofast -funroll-loops -fvariable-expansion-in-unroller -ftree-loop-if-convert-stores -fmerge-all-constants -fbranch-target-load-optimize2"
            ],
            "cflags_cc": [
